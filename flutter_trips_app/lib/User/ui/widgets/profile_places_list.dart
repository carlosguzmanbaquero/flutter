...
class ProfilePlacesList extends StatelessWidget {
  ...
  Place place = new Place(name: 'El gato foto 1', description: 'El Gato del Río es una obra del pintor y escultor Hernando Tejada la cual donó a la ciudad de Cali, Colombia, y que fue instalada en la ribera del río tutelar de la ciudad, en el sector noroeste de la ciudad, conocido como Normandía. Con el paso del tiempo se ha convertido en uno de los monumentos más emblemáticos de la ciudad,1​ junto con la estatua de Sebastián de Belalcázar y el Cerro de Cristo Rey.', urlImage: 'https://www.elpais.com.co/files/article_main/uploads/2020/02/29/5e59f6632a1dc.jpeg', userOwner: null, likes: 5);
